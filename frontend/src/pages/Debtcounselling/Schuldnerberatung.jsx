...
//                         <p className="text-[#BA8C61] text-xs uppercase tracking-widest font-bold mb-3">
//                           Pfändungsart wählen:
//                         </p>
...
//                                   }))
//                                 }
//                                 className={`p-3 text-sm text-left border transition-all ${formData.garnishType === type ? "border-[#BA8C61] bg-[#BA8C61] text-white" : "border-white/10 bg-white/5 text-white/60 hover:border-white/30"}`}
//                               >
//                                 {t(`extendedStatements.garnishOptions.${type}`)}
//                               </button>
//                             ),
...
//                                 }))
//                               }
//                               className={`flex-1 p-3 text-sm border transition-all ${formData.vehicleDocLocation === loc ? "border-[#BA8C61] bg-[#BA8C61] text-white" : "border-white/10 bg-white/5 text-white/60 hover:border-white/30"}`}
//                             >
//                               {t(
//                                 `extendedStatements.vehicleDocsOptions.${loc}`,
//                               )}
...
// const ExpandableCard = ({ name, label, checked, onChange, children }) => {
//   return (
//     <div
//       className={`transition-all duration-500 border rounded-sm ${checked ? "bg-white/10 border-[#BA8C61]/50 shadow-lg" : "bg-white/5 border-white/5 hover:border-white/20"} p-5`}
//     >
//       <label className="flex items-center gap-4 cursor-pointer group">
...
//           />
//           <div
//             className={`h-6 w-6 border-2 transition-all flex items-center justify-center ${checked ? "bg-[#BA8C61] border-[#BA8C61]" : "border-white/30 group-hover:border-white/60"}`}
//           >
//             {checked && (
//               <div
...
//         </div>
//         <span
//           className={`text-xl transition-colors ${checked ? "text-white font-medium" : "text-white/70"}`}
//         >
//           {label}
//         </span>
//       </label>
