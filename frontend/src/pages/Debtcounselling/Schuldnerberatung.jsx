...
//                       placeholder={t("fields.debtPlaceholder")}
//                     />
...
//                       onChange={handleChange}
//                       placeholder={t("fields.claimsPlaceholder")}
//                     />
...
//                       onChange={handleChange}
//                       placeholder={t("fields.incomePlaceholder")}
//                     />
//                   </>
//                 )}
...
//                         onChange={handleChange}
//                         className="w-full bg-transparent border-b border-white/20 py-3 outline-none focus:border-[#BA8C61]"
//                       >
//                         <option value="">---</option>

//                         {t("options.jobFields", { returnObjects: true }).map(
//                           (job, i) => (
...
//                       onChange={handleChange}
//                       placeholder="..."
//                       className="w-full bg-transparent border-b border-white/20 py-4 text-lg outline-none focus:border-[#BA8C61]"
//                     />
...
//                   className={`${
//                     step === 0 ? "invisible" : ""
//                   } flex items-center gap-2 text-white/40 hover:text-white transition`}
//                 >
...
//                   className="bg-white text-[#262B3E] px-10 py-3 font-bold hover:bg-[#BA8C61] hover:text-white flex items-center gap-2 transition-all"
//                 >
