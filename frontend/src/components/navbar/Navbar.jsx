              ...
              link.type === "dropdown" ? (
                <div key={link.name} className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className="flex items-center gap-1.5 text-white/80 hover:text-[#C9B38C] text-[11px] xl:text-[12px] 2xl:text-[17px] uppercase tracking-[0.22em] font-medium transition-all duration-200"
                  >
                    {link.name}
                    <ChevronDown
                      size={13}
                ...
                <a
                  ...
                  className="relative text-white/80 hover:text-[#C9B38C] text-[11px] xl:text-[12px] 2xl:text-[17px] uppercase tracking-[0.22em] font-medium transition-all duration-200 group"
                >
                  {link.name}
