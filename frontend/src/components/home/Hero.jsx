...
//           <img
//             src={slide1}
//             className="w-full h-full object-cover object-[75%_20%] scale-[0.999] origin-right"
//             alt="Hero"
//           />
...
//             className="flex items-center justify-center w-14 h-14 md:w-20 md:h-20 bg-[#b89473] hover:bg-white text-white hover:text-[#C9B38C] rounded-full shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-[#C9B38C]"
//           >
...
//       */}
//       <div className="w-full h-[60px] bg-[#1B2A4A]" aria-hidden="true" />
//     </>
//   );
// }
...
// import slide1 from "../../assets/hero_pic_01.jpeg";
// import mobile_hero from "../../assets/hero_mobile.jpg";
// import Video_Law from "../../assets/law_vid.mp4";
...
//           <img
//             src={slide1}
//             className="w-full h-full object-cover object-[60%_50%] md:object-[75%_20%] scale-[0.999] origin-right"
//             alt="Hero"
//           />
//           <div className="absolute inset-0 bg-gradient-to-r from-[#262B3E]/90 via-[#262B3E]/55 to-[#262B3E]/10" />
//           {/* stronger bottom fade on mobile so text stays readable */}
      ...
      >
        ...
        <div className="absolute inset-0">
          <picture className="w-full h-full">
            <source media="(max-width: 767px)" srcSet={mobile_hero} />
            <source media="(min-width: 768px)" srcSet={slide1} />
            <img
              src={slide1}
              className="w-full h-full object-cover object-center md:object-[75%_20%] scale-[0.999] origin-right"
              alt="Hero"
            />
          </picture>
          <div className="absolute inset-0 bg-gradient-to-r from-[#262B3E]/90 via-[#262B3E]/55 to-[#262B3E]/10" />
