...
import { ShieldCheck, Plus, ArrowRight, Contact, Send } from "lucide-react";
  ...
  return (
    ...
    >
        ...
        <div className="max-w-[1400px] w-full grid lg:grid-cols-12 gap-10 items-center z-10">
          <div className="lg:col-span-6 space-y-12 order-2 lg:order-1 text-left">
            ...
            <motion.p
              ...
              className="text-white font-light text-lg lg:text-2xl leading-relaxed max-w-md italic"
            >
              {t("intro.text2")}
            </motion.p>
          </div>
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center lg:justify-end gap-6 order-1 lg:order-2 h-[600px]">
            <motion.div
              ...
              className="relative w-[95%] lg:w-[85%] aspect-[15/10] overflow-hidden border border-white/10 shadow-2xl group cursor-pointer"
            >
              <img
                src={Both_Image}
                alt="Partners"
            ...
            {advantages.map((item, i) => (
              ...
              >
                <ShieldCheck
                  ...
                  strokeWidth={1}
                />
                <h4 className="text-3xl font-serif italic text-white mb-5 tracking-tight">
                  {item.title}
                </h4>
      ...
      <section className="py-40 flex flex-col items-center text-center px-6 bg-[#0D0F16]">
        ...
        {/* Wrap the plus icon in a motion.div or button with the click handler */}
        <motion.div
          onClick={scrollToContact} // Reusing your existing logic
