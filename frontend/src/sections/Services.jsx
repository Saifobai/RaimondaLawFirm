        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {services.map((service, idx) => (
            ...
            >
              ...
              {/* ── ZONE 2 (fixed height): title — same height on every card so divider always aligns ── */}
              ...
              {/* ── ZONE 3 (fixed bottom): divider + content ── */}
              ...
              {/* Mouse glow — blue+orange gradient, strong enough to see */}
              <div
                className="absolute -inset-4 opacity-0 lg:group-hover:opacity-100 pointer-events-none transition-opacity duration-500 blur-[55px]"
                style={{
                  background:
                    "radial-gradient(circle at 70% 80%, rgba(186,140,97,0.22) 0%, rgba(27,42,74,0.18) 50%, transparent 75%)",
                }}
              />
            </motion.div>
          ))}
