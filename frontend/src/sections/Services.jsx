...
export default function Services() {
  ...
  return (
    <section
      id="services"
      className="bg-[#262B3E] py-20 lg:py-44 overflow-hidden"
    >
      <div className="max-w-[1500px] mx-auto px-6">
        {/* HEADER */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20 lg:mb-32 items-center">
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <h2 className="text-5xl lg:text-8xl font-serif italic text-white leading-[0.9] tracking-tighter">
              {t("servicesSection.title")}
            </h2>
          </motion.div>
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="lg:pl-20 lg:border-l border-white/20"
          >
            <p className="text-white/80 text-lg lg:text-xl leading-relaxed font-light italic">
              {t("servicesSection.sideTitle")}
            </p>
          </motion.div>
        </div>

        {/* THE POWER GRID - Flex/Grid reordered for mobile */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* LEFT PARTNER: RAI */}
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="order-1 lg:col-span-4 h-[400px] lg:h-[700px] relative overflow-hidden group border border-white/10 shadow-sm"
          >
            <img
              src={Rai_Image}
              alt="Partner Rai"
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="order-3 lg:col-span-4 h-[400px] lg:h-[700px] relative overflow-hidden group border border-white/10 shadow-sm"
          >
            <img
              src={Auri_Image}
              alt="Partner Auri"
          ...
          {/* BOTTOM CTA BAR */}
          <motion.div className="order-4 lg:col-span-12 mt-4 lg:mt-8 p-10 lg:p-12 bg-black/20 flex flex-col items-center justify-center relative overflow-hidden">
            <a
              href="#contact"
              className="relative z-10 flex items-center gap-6 bg-[#BA8C61] text-[#262B3E] px-10 py-5 text-[11px] font-bold uppercase hover:bg-white transition-all duration-300 shadow-2xl"
            >
