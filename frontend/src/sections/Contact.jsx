...
//               {/* TEXTAREA - FIXED LABEL ISSUE */}
//               <div className="relative pt-8">
//                 {" "}
//                 {/* Added top padding for the floating label area */}
//                 <textarea
//                   rows={4}
//                   name="message"
//                   required
...
//                       : "top-14 left-6 text-white/50 text-[14px] peer-focus:-top-2 peer-focus:left-0 peer-focus:text-[#BA8C61] peer-focus:text-[11px]"
//                   }`}
//                 >
...
//                 className={`group relative text-white inline-flex items-center gap-12 pt-4 transition-all ${!isValid || loading ? "opacity-50 cursor-not-allowed" : "hover:gap-16"}`}
//               >
...
//                 className={`group cursor-pointer p-10 border transition-all duration-700 relative overflow-hidden ${activeKey === key ? "bg-white/[0.05] border-[#BA8C61]/40" : "bg-white/[0.02] border-white/5 hover:border-white/20"}`}
//               >
//                 <div
